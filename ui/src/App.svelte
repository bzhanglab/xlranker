    ...
    <div>
      ...
      >
        <div class="px-4">
          ...
          Please upload a tab-separated file containing peptide pairs, one pair per
          line. Each line should contain two peptides separated by a tab character.
